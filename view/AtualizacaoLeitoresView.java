...
public class AtualizacaoLeitoresView extends JFrame{
    ...
    public AtualizacaoLeitoresView() {
        setResizable(false);
        setTitle("Atualização de dados dos Leitores");
        setSize(797, 532);
        ...
        JLabel cl = new JLabel("Atualização de dados dos Leitores");
        ...
        JLabel tipoNovo = new JLabel("Tipo o novo tipo de leitor:");
        ...
        botaoCadastrar.addActionListener(e -> atualizarLeitor());
